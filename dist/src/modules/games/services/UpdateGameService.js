...
let UpdateGameService = class UpdateGameService {
    constructor(gamesRepository) {
        this.gamesRepository = gamesRepository;
    }
    async execute({ adminId, id, name, description, theme, levelInfo, ranks, }) {
        try {
            const game = await this.gamesRepository.findOne(id, adminId);
            if (!game)
                throw new implementations_1.RequestError('This game does not exist', errorCodes_1.default.RESOURCE_NOT_FOUND, 400);
...
UpdateGameService = __decorate([
    tsyringe_1.injectable(),
    __param(0, tsyringe_1.inject('GamesRepository')),
    __metadata("design:paramtypes", [Object])
], UpdateGameService);
exports.default = UpdateGameService;
