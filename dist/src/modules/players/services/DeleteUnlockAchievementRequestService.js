...
let DeleteUnlockAchievementRequestService = class DeleteUnlockAchievementRequestService {
    constructor(unlockAchievementRequestRepository, gamesRepository, transactionProvider) {
    ...
    async execute({ gameId, requestId, }) {
        ...
        const requestExists = await this.unlockAchievementRequestRepository.findOne(requestId);
        if (!requestExists)
...
DeleteUnlockAchievementRequestService = __decorate([
...
exports.default = DeleteUnlockAchievementRequestService;
